...
import { getTrendingMovies, updateSearchCount } from "./lib/backend.js";
...
const App = () => {
  ...
  useDebounce(() => setDebouncedMovieSearchTerm(MovieSearchTerm), 500, [MovieSearchTerm]);
  ...
  useEffect(() => {
    fetchMovies(debouncedMovieSearchTerm);
